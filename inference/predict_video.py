...
def main():
    ...
    parser.add_argument("--weight-path", default=None, type=str, help="Local path or URL to a trained checkpoint (required when --model-name=effort, ignored for timm-registered models)")
    ...
    video_predictor = VideoPredictor(args.margin_ratio, args.conf_thres, args.min_face_ratio,
                   args.model_name, args.model_dataset, args.weight_path)
