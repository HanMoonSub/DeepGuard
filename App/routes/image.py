...
# 사용자 전체 업로드 히스토리 조회 
@router.get("/history", status_code=status.HTTP_200_OK, summary="이미지 히스토리 전체 조회")
...
@router.get("/history/{image_id}", status_code=status.HTTP_200_OK, summary="이미지 개별 상세 조회")
...
# 이미지 히스토리 삭제
@router.delete("/history/{image_id}", status_code=status.HTTP_200_OK, summary="이미지 버튼 히스토리 삭제")
