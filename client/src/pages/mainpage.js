  ...
  return (
    <div style={containerStyle}>
      ...
      <nav style={navStyle}>
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <img 
            src={logo} 
            alt="Deep Guard" 
            style={{ height: '35px', marginRight: '50px', cursor: 'pointer' }} 
        ...
        <div>
          <button style={navBtnStyle} onClick={handleStartAnalysis}>이미지 분석</button>
          <button style={navBtnStyle} onClick={handleStartAnalysis}>동영상 분석</button>
          <button 
      ...
      <section style={{ ...sectionStyle, minHeight: '90vh' }}>
        ...
        <button style={startBtnStyle} onClick={handleStartAnalysis}>분석 시작 ❯</button>
      </section>
      ...
      <section style={{ ...sectionStyle, backgroundColor: '#050505', minHeight: '100vh', flexDirection: 'row', justifyContent: 'center', gap: '60px' }}>
        <div style={analysisBoxStyle}>
          ...
          <button style={{ ...startBtnStyle, fontSize: '18px', padding: '12px 30px', marginTop: 0 }} onClick={handleStartAnalysis}>업로드 ❯</button>
        </div>
      ...
      <footer style={{ padding: '80px', textAlign: 'center', backgroundColor: '#000', borderTop: '1px solid #222', zIndex: 2, position: 'relative' }}>
        <h2 
          onClick={handleHomeRedirect}
          style={{ color: '#39FF14', marginBottom: '20px', fontSize: '24px', cursor: 'pointer' }}
        >
          Deep Guard
        </h2>
