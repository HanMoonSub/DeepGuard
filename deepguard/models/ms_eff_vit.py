...
@register_model
def ms_eff_vit_b0(pretrained=False, type="asian", **kwargs) -> MultiScaleEffViT:
    ...
    if pretrained:
        pretrained_cfg = _get_config_for_type(variant, type)
    else:
...
@register_model
def ms_eff_vit_b5(pretrained=False, type="asian", **kwargs) -> MultiScaleEffViT:
