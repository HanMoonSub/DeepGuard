...
def build_effort_optimizer(model, cfg):
    """
    Constructs an optimizer with differential learning rates and weight decay exclusion.

    This builder segments the Effort parameters into two main components:
    1. Backbone (only the trainable SVD residual components of the frozen CLIP ViT-L/14)
    2. Head (binary classification head)
    """
    ...
    print(f"\n{'='*20} 📦 Parameter Groups Summary {'='*20}")
    display_names = {"backbone": "Backbone (SVD Residual)", "head": "Head"}
